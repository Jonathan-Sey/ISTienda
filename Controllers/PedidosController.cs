    ...
    public class PedidosController : BaseController
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var pedido = await _context.Pedidos
                .Include(p => p.Usuario)
                // relacionamos con la tabla detalle pedido
                .Include(p=>p.DetallesPedido)
                .ThenInclude(db=> db.Producto)
            ...
            pedido.Direccion=await _context.Direcciones.FirstOrDefaultAsync(
                d=>d.DireccionId == pedido.DireccionIdSeleccionada
                ) ?? new Direccion();
        ...
        public async Task<IActionResult> Create([Bind("PedidoId,UsuarioId,Fecha,Estado,DireccionIdSeleccionada,Total")] Pedido pedido)
        {
            ...
            ViewData["UsuarioId"] = new SelectList(_context.Usuarios, "UsuarioId", "Ciudad", pedido.UsuarioId);
            return View(pedido);
        }
